    ...
    <div class="mx-auto flex w-full max-w-7xl flex-col gap-8">
        ...
        <section id="novo-cliente" class="portal-card scroll-mt-6 p-5 sm:p-6">
            ...
            <form method="POST" action="{{ route('admin.customers.store') }}" class="grid gap-5 md:grid-cols-2">
                ...
                <label class="grid gap-1.5 text-sm font-medium">Endereço <span class="font-normal text-zinc-400">(opcional)</span><input name="address" value="{{ old('address') }}" class="h-11 rounded-xl border border-zinc-300 bg-white px-3 font-normal outline-none focus:border-violet-500 dark:border-zinc-700 dark:bg-zinc-900" /></label>
                <label class="grid gap-1.5 text-sm font-medium">Número<input name="address_number" value="{{ old('address_number') }}" class="h-11 rounded-xl border border-zinc-300 bg-white px-3 font-normal outline-none focus:border-violet-500 dark:border-zinc-700 dark:bg-zinc-900" /></label>
                <label class="grid gap-1.5 text-sm font-medium">Bairro<input name="province" value="{{ old('province') }}" class="h-11 rounded-xl border border-zinc-300 bg-white px-3 font-normal outline-none focus:border-violet-500 dark:border-zinc-700 dark:bg-zinc-900" /></label>
                <label class="grid gap-1.5 text-sm font-medium">Complemento<input name="complement" value="{{ old('complement') }}" class="h-11 rounded-xl border border-zinc-300 bg-white px-3 font-normal outline-none focus:border-violet-500 dark:border-zinc-700 dark:bg-zinc-900" /></label>
                <label class="grid gap-1.5 text-sm font-medium">Inscrição municipal<input name="municipal_inscription" value="{{ old('municipal_inscription') }}" class="h-11 rounded-xl border border-zinc-300 bg-white px-3 font-normal outline-none focus:border-violet-500 dark:border-zinc-700 dark:bg-zinc-900" /></label>
                <label class="grid gap-1.5 text-sm font-medium">Inscrição estadual<input name="state_inscription" value="{{ old('state_inscription') }}" class="h-11 rounded-xl border border-zinc-300 bg-white px-3 font-normal outline-none focus:border-violet-500 dark:border-zinc-700 dark:bg-zinc-900" /></label>
